...
acousticStudy <- paste0('TEST_pam20217a_glider_banter_', mission, '_acousticStudy.rds')
# name of filtered AcousticStudy file (RDS)
acousticStudyFiltered <- paste0('TEST_pam20217a_glider_banter_', mission, '_acousticStudyFiltered.rds')
...
rmarkdown::render(
  ...
  output_file = file.path(path_out, paste0("TEST_event_summary_report_glider_", 
